	...
	public List<GenericDropdownDTO> getDesignations(int departmentId) {
	  ...
	  public CampusDto getActiveCampusById(int campusId) {
	    ...
	    public List<GenericDropdownDTO> getAllActiveBanks() {
	        // Note: You don't have an 'is_active' field in your OrgBank entity, 
	        // so findByIsActive(1) might not work unless it's inherited 
	        // or you've omitted it from the code.
	        // Assuming the method exists:
	        List<OrgBank> activeBanks = orgBankRepository.findByIsActive(1);
